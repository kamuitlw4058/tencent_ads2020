...
def get_seq_data(f,maxlen,L=64):
    ...
    emb_model = Word2Vec.load(f'model/{f}_clk_ns_emb.model_{L}')
    print(emb_model)
...
transformer_block2 =  TransformerBlock(embed_dim * len(seq_output_list) , num_heads, ff_dim * len(seq_output_list) )
